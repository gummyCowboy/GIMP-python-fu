...
# Script Title: Yin-Yang 1.0
# Tested on GIMP version: 2.10.12, Windows 7, 64 bit.
#
# Copyright:
#   Copyright (C) <2017><2018><2019>  <Charles Bartley>
#
...
def draw_flow_selection(operation):
    ...
    'operation' is either an replacement, an addtion or a subtraction. """
...
def fill(color, material):
    """ Fills a selection on a 'YY.base' with a 'color'.
...
def render_yin_yang(
    ...
    if frame_count > 1:
        ...
        for frame in range(f - 1):
            ...
            _ = pdb.gimp_item_transform_rotate(
                layer_copy,
                math.radians(angle),
                TRUE,
                YY.center, YY.center)
